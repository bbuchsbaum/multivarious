...
#> [1] "Mean relative difference: 0.8059074"
```
...
#>  [4] dplyr_1.2.1          compiler_4.5.1       Rcpp_1.1.1          
...
#> [19] knitr_1.51           htmlwidgets_1.6.4    ggrepel_0.9.8       
#> [22] tibble_3.3.1         desc_1.4.3           chk_0.10.0          
#> [25] bslib_0.10.0         pillar_1.11.1        RColorBrewer_1.1-3  
#> [28] rlang_1.1.7          cachem_1.1.0         xfun_0.57           
#> [31] fs_2.0.1             sass_0.4.10          S7_0.2.1            
#> [34] otel_0.2.0           cli_3.6.5            withr_3.0.2         
#> [37] pkgdown_2.2.0        magrittr_2.0.5       digest_0.6.39       
#> [40] grid_4.5.1           irlba_2.3.7          lifecycle_1.0.5     
#> [43] vctrs_0.7.2          evaluate_1.0.5       glue_1.8.0          
#> [46] GPArotation_2025.3-1 corpcor_1.6.10       farver_2.1.2        
#> [49] ragg_1.5.2           rmarkdown_2.31       tools_4.5.1         
